jQuery(function() {
	...
	jQuery(".add_numvar").click(function(e) {
		e.preventDefault();
		var var_counter = jQuery('.new_var').length+1;
		console.log(var_counter);
		var new_row = "<tr class='new_var'><td colspan=2><label for='gviz_opts[f"+count+"_axis1_"+var_counter+"]'>Numeric:</label></td><td colspan=2><select name='gviz_opts[f"+count+"_axis1_"+var_counter+"]'>"+numlist+"</select></td><td><a href='' class='del_numvar button-secondary'>-</a></td><td class='t_divider'>&nbsp;</td></tr>";
